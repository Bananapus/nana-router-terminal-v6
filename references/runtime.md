...
- [`test/regression/RouterTerminalGatewayFailureTest.t.sol`](../test/regression/RouterTerminalGatewayFailureTest.t.sol) and [`test/regression/RouterTerminalGatewayBaseForkTest.t.sol`](../test/regression/RouterTerminalGatewayBaseForkTest.t.sol) for the exact Base reproduction, gas sweep, callback intake, nested allowances, matching-selector resets, real-core payer propagation, retries, and refunds.
